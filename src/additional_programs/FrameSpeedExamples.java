...
public class FrameSpeedExamples {
	...
	/*
	 * Mnohem složitìjší, hra jede poøád na 25 framech za sekundu, ale
	 * zobrazování se mùže dít i mezi updaty, jelikož ve høe musí být
	 * zakomponováno pøedvídání. Vizuálnì lepší než konstantní rychlost framù.
	 * 
	 * Pøedvídání: Auto jede rychlostí 100. V 5. updatu je ve vzdálenosti 500.
	 * Proto v 11. bude ve vzdálenosti 600. Mohu to zobrazit uprostøed updatù,
	 * proto promìnná interpolation má hodnotu 0,5. Proto jeho pozice v tomto
	 * èase by byla 550(speed*interpolation).
	 */
